...
int Check_Validity_of_Record(rec_ptr* head, char* recid, char* firstname, char* lastname, char* disid, char* coun, char* endate, char* exdate)
{
...
rec_ptr Insert_Record(rec_ptr* head, char* recid, char* firstname, char* lastname, char* disid, char* coun, char* endate, char* exdate)
{
